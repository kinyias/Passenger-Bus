...
controller.Paypal = (req, res, item, totalPrice, id) => {
    var create_payment_json = {
        ...
        "redirect_urls": {
            "return_url": "https://project-PassengerBus.onrender.com/search-trip/" + id + "/thanh-toan/thanhcong",
            "cancel_url": "https://project-PassengerBus.onrender.com/search-trip/" + id + "/thanh-toan/thatbai"
        },
        "transactions": [{
            "item_list": {
                "items": item
